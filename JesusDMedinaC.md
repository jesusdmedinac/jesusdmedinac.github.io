...
**Bubble**
* Modular smartphone addiction management app built with **KMP**, integrating AI-driven personalization and real-time screen time tracking.

**Empry**
* AI co-pilot for building startups. Get instant expert guidance on fundraising, legal matters, product development, and growth strategies.

**Zora**
* AI-driven platform connecting drivers and yards through conversational AI to find auto parts in minutes.
...
* **DevExpert.io Certifications:** Compose Expert (2025), Testing Expert (2023), Kotlin Expert (2022), Architect Coders (2020), Kotlin para Desarrolladores Android (2019).
* **Other Certifications:** Python Crash Course – ITJ (2024).
